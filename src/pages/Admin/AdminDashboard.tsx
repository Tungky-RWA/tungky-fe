...
const AdminDashboard = () => {
  ...
  const quickActions = [
    {
      title: 'Review Brand',
      description: 'Review brands that registered to our platform',
      icon: Users,
      path: '/admin/brand',
      color: 'crypto',
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="space-y-4 text-center">
        <h1 className="text-5xl font-bold blockchain-gradient animate-glow">Admin Dashboard</h1>
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          Kelola Aktivitas Brand
        </p>
