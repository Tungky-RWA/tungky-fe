...
export default function NFTCard({
  ...
  return (
    <Card className="w-full max-w-2xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-[#0077C0]/20 hover:-translate-y-1 cursor-pointer group 
                   bg-[#1D242B]/40 backdrop-blur-lg border border-[#C7EEFF]/10 rounded-2xl">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col items-end space-y-1">
                  <div className="flex items-center gap-1">
                    ...
                    <div className="w-1 h-6 bg-[#C7EEFF]/80 rounded animate-pulse" style={{ animationDelay: "0.2s" }} />
