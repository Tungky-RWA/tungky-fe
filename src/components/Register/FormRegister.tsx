...
function EnhancedLogoUploader({
  onLogoChange,
  className = "",
}: EnhancedLogoUploaderProps) {
        ...
        {logoPreviewUrl ? (
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <p className="text-[#FAFAFA] text-sm font-medium truncate max-w-xs mx-auto">
                {fileName}
              </p>
          ...
          <div className="space-y-3">
            ...
            <div>
              <p className="text-[#FAFAFA] font-medium">
                <span className="text-violet-400">Upload a file</span> or drag
                and drop
              </p>
...
export default function FormRegister() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const imageLinkIpfs = await uploadFileToPinata(
      logoFile,
      "logo_" + formData.companyName
    );
  ...
  if (isLoadingBrandInfo) {
    return (
      <div className="text-center p-8 text-[#FAFAFA]">
  ...
  return (
    ...
    >
      <CardHeader className={cn("text-center space-y-4 pb-6")}>
        <CardTitle
          className={cn("text-3xl font-bold tracking-tight text-[#FAFAFA]")}
        >
          Brand Registration
        </CardTitle>
        {!brandInfo?.name && (
          <CardDescription className={cn("text-base text-gray-400")}>
        ...
        {brandInfo?.name ? (
          <div className="text-center space-y-4">
            ...
            <p className="text-[#FAFAFA]">
              Your brand (
              <span className="font-semibold">{brandInfo.name}</span>) is under
              review by our team.
            </p>
            <Button
          ...
          <>
            <div className="space-y-2">
              <Label htmlFor="walletAddress" className="text-[#FAFAFA]">
            ...
            >
                ...
                <div className="w-full lg:w-1/2 space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      type="text"
                      placeholder="e.g., Digital Innovation Inc."
                      required
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      type="text"
                      placeholder="e.g., 123/PMA/2024"
                      className={inputStyles}
                    />
                  </div>
                  <div>
                    <Label htmlFor="brandName" className="text-[#FAFAFA]">
                    ...
                    <Input
                      ...
                      type="text"
                      placeholder="e.g., Authentify"
                      required
                      className={inputStyles}
                    />
                  </div>
                  <div>
                    <Label htmlFor="identityNumber" className="text-[#FAFAFA]">
                      PIC National ID Number{" "}
                    ...
                    <Input
                      ...
                      type="text"
                      placeholder="16-digit National ID of PIC"
                      required
                      className={inputStyles}
                    />
                  </div>
                  <div>
                    <Label htmlFor="websiteLink" className="text-[#FAFAFA]">
                      Website
                    </Label>
                    <Input
                      id="websiteLink"
                  ...
                  <div>
                    <Label htmlFor="picName" className="text-[#FAFAFA]">
                  ...
                  <div>
                    <Label htmlFor="phoneNumber" className="text-[#FAFAFA]">
                      Phone Number
                    </Label>
                    <Input
                      id="phoneNumber"
              ...
              <div className="pt-6 mt-6 border-t border-white/20">
                <div className="flex items-center space-x-2">
                  ...
                  >
                    I agree to the applicable policies and terms{" "}
                    <span className="text-red-500">*</span>
                  </label>
                </div>
              ...
              {transactionUrl && (
                <div className="text-center mt-6">
                  <a
                    ...
                    className={`inline-flex items-center gap-2 text-${accentCyan} hover:text-${accentCyanHover}`}
                  >
